...
public class DetaillesParametresVitauxM implements Initializable {
    ...
    void updateButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ParametresVitauxM/UpdateParametresVitauxM.fxml"));
            Parent root = loader.load();

            // 💡 Récupération du contrôleur de la page de mise à jour
            UpdateParametresVitauxM controller = loader.getController();

            // 🟢 Passage des données à mettre à jour
            controller.setParametresVitauxM(parametresVitaux);
